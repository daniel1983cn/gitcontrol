<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"E:\xampp\htdocs\gitcontrol\public/../application/admin\view\index\index.html";i:1689043529;s:66:"E:\xampp\htdocs\gitcontrol\application\admin\view\common\meta.html";i:1689043529;s:68:"E:\xampp\htdocs\gitcontrol\application\admin\view\common\header.html";i:1689043529;s:66:"E:\xampp\htdocs\gitcontrol\application\admin\view\common\menu.html";i:1689043529;s:69:"E:\xampp\htdocs\gitcontrol\application\admin\view\common\control.html";i:1689043529;s:68:"E:\xampp\htdocs\gitcontrol\application\admin\view\common\script.html";i:1689043529;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- 加载样式及META信息 -->
...
<link rel="shortcut icon" href="/gitcontrol/public/assets/img/favicon.ico" />
<!-- Loading Bootstrap -->
<link href="/gitcontrol/public/assets/css/backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">

<?php if(\think\Config::get('fastadmin.adminskin')): ?>
<link href="/gitcontrol/public/assets/css/skins/<?php echo \think\Config::get('fastadmin.adminskin'); ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">
<?php endif; ?>

<!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
<!--[if lt IE 9]>
  <script src="/gitcontrol/public/assets/js/html5shiv.js"></script>
  <script src="/gitcontrol/public/assets/js/respond.min.js"></script>
<![endif]-->
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="hidden-xs">
                    <a href="/gitcontrol/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i> <?php echo __('Home'); ?></a>
                </li>
    ...
    <ul class="sidebar-menu <?php if(\think\Config::get('fastadmin.show_submenu')): ?>show-submenu<?php endif; ?>">
        ...
        <?php echo $menulist; ?>
            ...
            <footer class="main-footer hide">
                ...
                <strong>Copyright &copy; 2017-<?php echo date("Y"); ?> <a href="/gitcontrol/public/"><?php echo $site['name']; ?></a>.</strong> All rights reserved.
            </footer>
...
<!-- /.control-sidebar -->
        ...
        <!-- 加载JS脚本 -->
        <script src="/gitcontrol/public/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/gitcontrol/public/assets/js/require-backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo htmlentities($site['version']); ?>"></script>
    </body>
</html>
