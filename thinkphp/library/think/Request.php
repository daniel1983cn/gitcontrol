...
class Request
{
    ...
    public function post($name = '', $default = null, $filter = '')
    {
        ...
        if (is_array($name)) {
//            echo "name:";var_dump($name);echo ";\n";
//            echo "postinfo::";var_dump($this->post);echo ";\n";
            $this->param       = [];
            $this->mergeParam  = false;
...
//            var_dump(explode('.', $name));
            foreach (explode('.', $name) as $val) {
                if($val=="branch_params"){
//                    echo ":::".$val."!!!!";
//                    var_dump($data[$val]);echo ",end\n";
                }
                if (isset($data[$val])) {
                    $data = $data[$val];
                } else {
        ...
        if (is_array($data)) {
            array_walk_recursive($data, [$this, 'filterValue'], $filter);
            reset($data);
//            echo "ininininininin";var_dump($data);
        } else {
            $this->filterValue($data, $name, $filter);
        }
